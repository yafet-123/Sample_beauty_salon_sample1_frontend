...
export function Beauyreatment() {
  return (
    <div className="flex flex-col">
      <div className="beauytreatment-background-one w-full h-[30rem] relative">
        <div className="bg-transparent w-3/4 lg:w-[40rem] h-96 p-5 lg:p-10 absolute top-0 right-0 bottom-0 left-10 my-auto flex flex-col justify-center border-4 border-white">
          ...
          <p className="text-left text-white font-normal text-xl capitalize">
      ...
      <div className="beauytreatment-background-two w-full h-[30rem] relative">
        <div className="bg-transparent w-3/4 lg:w-[40rem] h-96 p-5 lg:p-10 absolute top-0 right-10 bottom-0 my-auto flex flex-col justify-center">
          ...
          <p className="text-left text-black font-normal text-xl capitalize">
          ...
          <button className="px-5 py-2 text-left bg-indigo-900 capitalize text-lg w-1/4 my-5 rounded-lg">
            Learn more
          </button>
        </div>
      </div>
